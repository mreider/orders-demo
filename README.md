...
[![build](https://github.com/mreider/orders-demo/actions/workflows/build.yml/badge.svg)](https://github.com/mreider/orders-demo/actions/workflows/build.yml)
[![deploy](https://github.com/mreider/orders-demo/actions/workflows/deploy.yml/badge.svg)](https://github.com/mreider/orders-demo/actions/workflows/deploy.yml)
[![pages](https://github.com/mreider/orders-demo/actions/workflows/pages.yml/badge.svg)](https://github.com/mreider/orders-demo/actions/workflows/pages.yml)
[![release](https://github.com/mreider/orders-demo/actions/workflows/release.yml/badge.svg)](https://github.com/mreider/orders-demo/actions/workflows/release.yml)
...
- The same image runs in two namespaces on the same cluster:
  - `orders-sdv1`: SDv1 detection, plus a second workload (`orders-demo-named`) with `OTEL_SERVICE_NAME` set, which powers the `service.name` prefix demo.
...
- A presentation under `presentation/` walks the migration in **two sections** (one workload one service; dimensions do the slicing), paired with **one unified demo notebook** of ten DQL questions that runs against the speaker's (or customer's) own tenant.
...
presentation/   Two-section narrative + Marp slides + one unified sdv2-demo.yaml notebook + built pptx
...
- `sdv2-demos-<tag>.zip`: the unified demo notebook YAML.
